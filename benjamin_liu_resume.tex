...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Deep Learning Side Channel Attack} $|$ \emph{Python, Pytorch, Numpy, Scipy, Keras, Pyvisa}}{January 2024 -- Ongoing}
          \resumeItemListStart
            ...
            \resumeItem{Utilized Pyvisa to automate the process of collecting power traces and interfacing with the oscilloscope.}
          \resumeItemListEnd
          \vspace{-13pt}
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Shell Scripting in Linux, Git, Agile Methodologies} \\
     \textbf{Technologies/Frameworks}{: SQL, Numpy, OpenCV, Pytorch} \\
    }}
 \end{itemize}
 \vspace{-16pt}
